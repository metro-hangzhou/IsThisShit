...
This file classifies the current test surface into active domains.
...
## Historical test surface

Deleted-but-tracked test files from `HEAD` are preserved in the tests archive and should currently be treated as historical/harness surface until intentionally restored to active use.
