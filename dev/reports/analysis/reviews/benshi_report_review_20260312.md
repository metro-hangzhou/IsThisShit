...
But they are not enough to be stated as direct fact for:

- malicious intent
- deliberate derailment
- social-status strategy

Those stronger claims are not forbidden forever, but they should only enter a separate hypothesis layer when evidence is strong enough.

That means:

- they must be labeled as motive/adversarial hypotheses
- they must cite second-order evidence or repeated contextual support
- they must carry confidence and uncertainty boundaries
- they must not be presented as direct observed fact
