...
- 记录已经完成的关键工作
- 指引下一步主线开发应该往哪里走
- 把根目录主文档、`dev/agents/`、`dev/todos/`、`dev/reports/`、`dev/handbooks/`、`scripts/`、`tests/` 的关键文件串起来
...
### [2026-03-27][057] NapCat runtime surface has been split into vendored shell, mutable state, plugin surface, generated artifacts, and repo launcher bridge

- repository now has a canonical NapCat runtime surface map:
  - [../napcat/INDEX.md](../napcat/INDEX.md)
  - [../napcat/runtime_surface.md](../napcat/runtime_surface.md)
  - [../napcat/runtime_state_and_plugins.md](../napcat/runtime_state_and_plugins.md)
- this pass makes one boundary explicit:
  - `NapCat/` is not a single undifferentiated tree
  - it mixes vendored shell, mutable state, plugins, generated assets, and repo-side launcher bridges
- operator/runtime handbook companion:
  - [../../handbooks/runtime/NapCatRuntime.md](../../handbooks/runtime/NapCatRuntime.md)
- archive snapshot:
  - [../../archive/system_refactor_20260327/napcat_runtime_surface_20260327/README.md](../../archive/system_refactor_20260327/napcat_runtime_surface_20260327/README.md)
...
- 新增：
  ...
  - [../reports/analysis/reference/benshi_local_ontology.md](../reports/analysis/reference/benshi_local_ontology.md)
...
- 对应追踪已写入：
  - [git_branching_plan.md](../branching/git_branching_plan.md)
...
以 [git_branching_plan.md](../branching/git_branching_plan.md) 为准：
...
### 8.4 `dev/reports/` / `dev/archive/` 参考与归档

- [../analysis/INDEX.md](../analysis/INDEX.md)
- [../branching/git_branching_plan.md](../branching/git_branching_plan.md)
- [../reports/analysis/reference/benshi_local_ontology.md](../reports/analysis/reference/benshi_local_ontology.md)
- `Q群群友史.docx`

### 8.5 `scripts/` / `tests/` 结构入口

- [scripts/INDEX.md](/d:/Coding_Project/IsThisShit/scripts/INDEX.md)
- [tests/INDEX.md](/d:/Coding_Project/IsThisShit/tests/INDEX.md)
- [tests/test_matrix.md](/d:/Coding_Project/IsThisShit/tests/test_matrix.md)

### 8.6 `src/` 表面入口

- [src/INDEX.md](/d:/Coding_Project/IsThisShit/src/INDEX.md)
- [src/INDEX.zh-CN.md](/d:/Coding_Project/IsThisShit/src/INDEX.zh-CN.md)
